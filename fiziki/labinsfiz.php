...
<head>
    <meta charset="UTF-8">
    <title>Гражданская ответственность для физических лиц</title>
...
<table border="0" width="100%" height="100%" style="border-collapse: collapse;">
    ...
    <tr>
        <td>
            <ul>
                <br/>
                <p style="margin-left:100px; "><a href="../index.php" style="background: transparent">Главная</a>/<a href="">Физическим лицам</a>/Страхование ответственности</p>
                <br/>
                <h1 >Страхование гражданской ответственности физических лиц:</h1>
                <br/>
                <li><a href="" class="spec-button " style="margin-left:100px" id="T1"><span>Страхование гражданской ответственности граждан</span></a>
