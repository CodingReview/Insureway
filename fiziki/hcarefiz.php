...
<head>
    <meta charset="UTF-8">
    <title>Страхование жизни и здоровья</title>
...
<table border="0" width="100%" height="100%" style="border-collapse: collapse;">
    ...
    <tr>
        <td>
            <ul>
                <br/>
                <p style="margin-left:100px; "><a href="../index.php" style="background: transparent">Главная</a>/<a href="">Физическим лицам</a>/Страхование жизни и здоровья</p>
                <br/>
                <h1 >Страхование жизни и здоровья для физических лиц:</h1>
                <br/>
                <li><a href="" class="spec-button" style="margin-left:100px"><span>Страхование от несчастных случаев</span></a>
                    <a href="" class="spec-button"><span>С защитой от клеща</span></a>
                    <a href="" class="spec-button"><span>Страхование от COVID-19</span></a>
                </li>
            </ul>
        </td>
    </tr>
