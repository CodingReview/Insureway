...
<head>
    <meta charset="UTF-8">
    <title>Автострахование для физлиц</title>
 ...
 <table border="0" width="100%" height="100%" style="border-collapse: collapse;">
    ...
    <tr>
        <td>
            <ul>
                <br/>
                <p style="margin-left:100px; "><a href="../index.php" style="background: transparent">Главная</a>/<a href="">Физическим лицам</a>/Австострахование</p>
                <br/>
                <h1 >Страхование авто для физических лиц:</h1>
                <br/>
                <li><a href="autokasko.php" class="spec-button" style="margin-left:100px"><span>Автокаско</span></a>
                    <a href="" class="spec-button"><span>Страхование ответственности</span></a>
                    <a href="greencard.php" class="spec-button"><span>Зеленая карта</span></a>
                </li>
            </ul>
        </td>
    </tr>
