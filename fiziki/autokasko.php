...
<head>
    <meta charset="UTF-8">
    <title>Автокаско для физлиц</title>
...
<table border="0" width="100%" height="100%" style="border-collapse: collapse;">
    ...
    <tr>
        <td>
            <ul>
                <br/>
                <p style="margin-left:100px; "><a href="../index.php" style="background: transparent">Главная</a>/<a href="">Физическим лицам</a>/<a href="">Автострахование</a>/Автокаско</p>
                <br/>
                <h1 >Автокаско для физических лиц:</h1>
                <br/>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <tr>
            <td>
                <div class="content">
                    <p style="font-size: 20px;">
                        Покупая полис КАСКО в INSUREWAY вы получаете:
                    </p>
        ...
        <tr>
            <td>
                <div class="content">
                    <p style="font-size: 20px;">
                        В зависимости от объема страховой защиты и стоимости страхования можно выбрать подходящий для себя вариант страхования:
                    </p>
                    <ul class="special-li" style="margin-left: 16px;margin-bottom: 10px;">
                        <li>
                            <span>Базовый;</span>
