...
<head>
    <meta charset="UTF-8">
    <title>Страхование жизни и здоровья для юрлиц</title>
    <link rel="stylesheet" href="../stylesheets/hcare.css">
...
<table border="0" width="100%" height="100%" style="border-collapse: collapse;">
    ...
    <tr>
        <td>
            <ul>
                <br/>
                <p style="margin-left:100px; "><a href="../index.php" style="background: transparent">Главная</a>/<a href="">Юридическим лицам</a>/Страхование жизни и здоровья</p>
                <br/>
                <h1 >Страхование жизни и здоровья для юридических лиц:</h1>
                <br/>
                <li><a href="" class="spec-button" style="margin-left:100px"><span>Страхование медицинских расходов</span></a>
                    <a href="" class="spec-button"><span>Добровольное страхование от несчастных случаев и болезней</span></a>
                    <a href="" class="spec-button"><span>Страхование водителей и пассажиров от несчастных случаев</span></a>
                </li>
            </ul>
        </td>
    </tr>
