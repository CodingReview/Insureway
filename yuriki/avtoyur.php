...
<head>
    <meta charset="UTF-8">
    <title>Автострахование для юрлиц</title>
    <link rel="stylesheet" href="../stylesheets/autoyur.css">
...
<table border="0" width="100%" height="100%" style="border-collapse: collapse;">
    ...
    <tr>
        <td>
            <ul>
                <br/>
                <p style="margin-left:100px; "><a href="../index.php" style="background: transparent">Главная</a>/<a href="">Юридическим лицам</a>/Австострахование</p>
                <br/>
                <h1 >Страхование авто для юридических лиц:</h1>
                <br/>
                <li><a href="" class="spec-button" style="margin-left:100px"><span>Страхование гражданской ответственности и расходов перевозчика</span></a>
                    <a href="" class="spec-button"><span>Страхование ГО перевозчика, выполняющего внутренние перевозки</span></a>
                    <a href="" class="spec-button"><span>Страхование ГО владельцев автотранспортных средств</span></a>
                </li>
            </ul>
        </td>
    </tr>
