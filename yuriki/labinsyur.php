...
<head>
    <meta charset="UTF-8">
    <title>Гражданская ответственность для юридических лиц</title>
...
<table border="0" width="100%" height="100%" style="border-collapse: collapse;">
    ...
    <tr>
        <td>
            <ul>
                <br/>
                <p style="margin-left:100px; "><a href="../index.php" style="background: transparent">Главная</a>/<a href="">Юридическим лицам</a>/Страхование ответственности</p>
                <br/>
                <h1 >Страхование гражданской ответственности юридических лиц:</h1>
                <br/>
                <li><a href="" class="spec-button " style="margin-left:100px" id="T1"><span>Страхование гражданской ответственности и расходов перевозчика</span></a>
                    <a href="" class="spec-button" id="T2"><span>Страхование гражданской ответственности владельцев автотранспортных средств</span></a>
                </li>
            </ul>
        </td>
    </tr>
