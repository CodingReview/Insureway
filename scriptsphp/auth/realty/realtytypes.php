...
<head>
    <script>
        document.onclick = function(){
            var radioInput = document.getElementsByName('radio-realty');
            if (radioInput[0].checked == true){window.location.href="";}
            if (radioInput[1].checked == true){window.location.href="";}
            if (radioInput[2].checked == true){window.location.href="";}
            if (radioInput[3].checked == true){window.location.href="";}
        }
    </script>
    <meta charset="UTF-8">
...
<table border="0" width="100%" height="100%" style="border-collapse: collapse;">
    ...
    <td>
        ...
        <ul class="hr">
            <li><div class="form_radio_btn">
                    <input id="radio-vehicle-1" type="radio" name="radio-realty" value="1">
                    <label for="radio-vehicle-1">Квартира</label>
                </div></li>
            <li><div class="form_radio_btn">
                    <input id="radio-vehicle-2" type="radio" name="radio-realty" value="2">
                    <label for="radio-vehicle-2">Дом</label>
                </div></li>
            <li><div class="form_radio_btn">
                    <input id="radio-vehicle-3" type="radio" name="radio-realty" value="3">
                    <label for="radio-vehicle-3">Гараж</label>
                </div></li>
